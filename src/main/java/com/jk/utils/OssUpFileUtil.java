...
public class OssUpFileUtil {
     ...
     */
    private static String accessKeyId = "LTAIldCnpbz354xn";
    private static String accessKeySecret = "jM9hSaYJFiBUMNOXtIO355fhB0S7XR";
    /**
     * Bucket命名规范如下：只能包括小写字母，数字和短横线（-），必须以小写字母或者数字开头，长度必须在3-63字节之间。
     */
    private static String bucketName = "image614";
    /**
     * OSS文件夹名称
     */
    private static String firstHost = "photo";
    /**
